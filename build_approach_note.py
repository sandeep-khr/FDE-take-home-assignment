...
def build_document():
    ...
    add_para(doc, "I used Claude to explore the case packet, surface traps and pair-build the tested pipeline. I checked results through the tests, golden run and independent calculations. I made the choices on framing, thresholds, human review and scope. The repository includes the full AI usage log.", after=0)
